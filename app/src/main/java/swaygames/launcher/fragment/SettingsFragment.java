package swaygames.launcher.fragment;
...
import swaygames.launcher.other.Utils;
                ...
                .setOnClickListener(
                        new View.OnClickListener() {
                            public void onClick(View v) {
								...
								startActivity(new Intent(getActivity(), swaygames.launcher.activity.LoaderActivity.class));
                            }
        });
